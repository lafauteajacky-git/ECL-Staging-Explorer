...
from modules.ead_engine import add_synthetic_ead_inputs
...
def generate_portfolio(n_exposures: int = 1_000, seed: int = 42) -> pd.DataFrame:
    ...
    portfolio = add_synthetic_ead_inputs(portfolio, seed=seed + 4_000)
...
def generate_demo_portfolio(
    ...
    portfolio = add_lifetime_pd_metrics(portfolio)
    portfolio = add_synthetic_ead_inputs(portfolio, seed=seed + 14_000)
